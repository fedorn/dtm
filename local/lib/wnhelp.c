...
static char *nounhelps[] = { hyper_help, relatives_help, ant_help, coord_help,
		hypertree_help, hypo_help, hypotree_help, holo_help, holotree_help,
		mero_help, merotree_help, deriv_help, nattrib_help, domain_help,
		domainterms_help, freq_help, grep_help };

static char *verbhelps[] = { hyper_help, relatives_help, ant_help, coord_help,
		hypertree_help, tropo_help, entail_help, causeto_help, deriv_help,
		frames_help, domain_help, domainterms_help, freq_help, grep_help };
...
",
				aattrib_help, domain_help, domainterms_help, freq_help,
				grep_help
...
",
				ant_help, domain_help, domainterms_help, freq_help, grep_help };
