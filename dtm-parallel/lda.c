...
DEFINE_bool(new_phi, true, "If true, use the new phi calculation.");

DEFINE_int32(nterms, 0, "Number of terms.");
DEFINE_int32(ntopics, 0, "Number of topics.");

DEFINE_int32(number_tasks, 5, "Number of tasks.");
...
DEFINE_string(normalize_docs, "normalize",
		"How should we transform docs' word counts? " "Options: take the log (log), normalize so they sum to 1 (normalize), " "take the count (identity), set positive counts to 1 (occurrence).");
