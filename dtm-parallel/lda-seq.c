...
DEFINE_double(phi_squared_factor, 1.0, "Scale factor for squared phi terms.");

DEFINE_int32(lda_sequence_max_em_iter, 30, "The maximum number of iterations.");
DEFINE_int32(lda_sequence_min_iter, 1, "The maximum number of iterations.");

DEFINE_string(seq_topic_filename, "", "The sequential topics filename.");
...
DEFINE_string(model, "fixed",
		"The function to perform. " "Can be dtm or fixed.");
DEFINE_string(resume_stage, "lda",
