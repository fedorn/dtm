...
DEFINE_bool(run_locally, false, "If true, run locally.");
DEFINE_string(bin_directory, ".", "The directory in which binaries live.");
DEFINE_bool(resume, false, "If true, resume a halted job.");
